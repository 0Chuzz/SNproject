...
#define UNASSIGNMENT_COST 50
/*
static short step = 1;
static short rowCover[NUM_BLOBS_MAX];
static short colCover[NUM_BLOBS_MAX];
static unsigned char stars[NUM_BLOBS_MAX][2];
static int curStar = 0;

static unsigned char primes[NUM_BLOBS_MAX][2];
